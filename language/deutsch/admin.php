<?php
/*
* $Id: admin.php,v 1.1 2006/03/27 14:52:03 mikhail Exp $
* Module: WF-Quote
* Version: v1.00
...
define('_AM_QUOTEVALTXT', 'Erlaubt Ihnen neu eingeschickte Zitate zu l&ouml;schen oder zu &uuml;berpr&uuml;fen.');
/*
* Lang defines for Category.php
*/
define('_AM_QUOTERECOUNT', 'Zitate neu z&auml;hlen');
define('_AM_QUOTERECOUNTTXT', 'Erlaubt Ihnen die Anzahl der Zitate in jeder Kategorie neu zu z&auml;hlen.');
...
define('_AM_NOTCTREATEDACAT', 'Sie m&uuml;ssen erst eine Kategorie erstellen, bevor Sie Zitate hinzuf&uuml;gen!');
...
*/
define('_AM_VISITSUPPORT', 'Besuchen Sie die WF-Section Website f&uuml;r mehr Informationen/Updates oder Hilfen f&uuml;r die Benutzung.<br> WF-Quotes v1 Hsalazar/Catzwolf &copy; 2005 <a href="http://wfsections.xoops2.com/" target="_blank">WF-Quotes</a>');
