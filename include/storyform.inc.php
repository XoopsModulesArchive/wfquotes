<?php
/*
* $Id: storyform.inc.php,v 1.1 2006/03/27 14:52:01 mikhail Exp $
* Module: WF-Snippets
* Version: v1.00
...
$sform = new XoopsThemeForm(_MI_QUOTESUB_SMNAME1, 'storyform', xoops_getenv('PHP_SELF'));
...
$sform->addElement(new XoopsFormDhtmlTextArea(_MD_QUOTETITLE, 'quotext', $quotext, 15, 60), true);
$sform->addElement(new XoopsFormText(_MD_QUOTEBODY, 'author', 50, 80, $author), true);
$sform->addElement(new XoopsFormDhtmlTextArea(_MD_QUOTESUM, 'reference', $reference, 7, 60));
...
if ($xoopsUser) {
    ...
    $notify_checkbox->addOption(1, _MD_QUOTNOTONPUB);
