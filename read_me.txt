/* 
* $Id: read_me.txt,v 1.1 2006/03/27 14:52:00 mikhail Exp $
* Module: WF-Snippets
* Version: v1.00
...
Needing to put short pieces of text on your website?  This could be code, book or basically anything type of quotes you want to give to your users.  WF-Snippets is easy to use, clean interface and will allow you to have content on your website in seconds.

WF-Snippets is smarty enabled (templates and cached files), makes use of Xoops comments and search functions.  Categories and topics are shown by their weight and can be hidden through the use of Groupaccess and you users can vote and rate each quotepet. 
...
D. Title:  The quotext you will give to a topic (Same for each Category).
